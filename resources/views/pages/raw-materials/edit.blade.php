...
@section('title', 'Modifier Matière Première')
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title">Modifier Matière Première</h4>
                ...
                <div class="card">
                    <div class="card-header card-header-custom d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0" style="color:white">
                            <i class="fas fa-edit me-2"></i>Modifier : {{ $material->material_name }}
                        </h5>
                        <div>
                        ...
                        <form id="editMaterialForm">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="material_code" name="material_code"
                                        value="{{ $material->material_code }}" required maxlength="20"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="material_name" name="material_name"
                                        value="{{ $material->material_name }}" required maxlength="100"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control" id="unit_of_measure" name="unit_of_measure" required>
                                        ...
                                        @foreach ($units as $unit)
                                            <option value="{{ $unit }}"
                                                {{ $material->unit_of_measure == $unit ? 'selected' : '' }}>
                                                {{ $unit }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="min_stock_level" name="min_stock_level"
                                        value="{{ $material->min_stock_level }}" step="0.01" min="0"
                                        placeholder="Ex: 100">
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="max_stock_level" name="max_stock_level"
                                        value="{{ $material->max_stock_level }}" step="0.01" min="0"
                                        placeholder="Ex: 1000">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="prix_client" name="prix_client"
                                        value="{{ $material->prix_client }}" step="0.01" min="0">
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="prix_grossiste" name="prix_grossiste"
                                        value="{{ $material->prix_grossiste }}" step="0.01" min="0">
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="prix_commercial" name="prix_commercial"
                                        value="{{ $material->prix_commercial }}" step="0.01" min="0">
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="prix_special" name="prix_special"
                                        value="{{ $material->prix_special }}" step="0.01" min="0">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-control" id="is_active" name="is_active">
                                        <option value="1" {{ $material->is_active ? 'selected' : '' }}>Actif</option>
                                        <option value="0" {{ !$material->is_active ? 'selected' : '' }}>Inactif
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="notes" name="notes" rows="3"
                                    placeholder="Informations supplémentaires...">{{ $material->notes }}</textarea>
                            </div>
                            ...
                            <div class="alert alert-info">
                                ...
                                <ul class="mb-0">
                                    <li>Le stock actuel est de <strong>{{ number_format($material->current_stock, 2, ',', '.') }}
                                            {{ $material->unit_of_measure }}</strong></li>
                                    <li>Le coût moyen est de <strong>{{ number_format($material->average_unit_cost, 2, ',', '.') }}
                                            DH</strong></li>
                                    <li>Le stock et le coût sont automatiquement gérés via les achats</li>
                                </ul>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editMaterialForm').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('raw-materials.update', $material->material_id) }}",
                    type: "POST",
                    data: $(this).serialize(),
