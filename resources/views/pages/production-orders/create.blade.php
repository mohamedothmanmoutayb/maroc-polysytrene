            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title">Nouvel Ordre de Production</h4>
                ...
                <div class="card">
                    <div class="card-header card-header-custom">
                        <h5 class="card-title mb-0" style="color:white">
                            <i class="fas fa-plus-circle me-2"></i>Créer un Nouvel Ordre de Production
                        </h5>
                    </div>
                    <div class="card-body">
                        <form id="productionOrderForm">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="form-check card h-100">
                                                <input class="form-check-input" type="radio" name="production_type"
                                                    id="type1Production" value="type1" checked>
                            ...
                            <div class="row mb-4">
                                ...
                                <!-- Type 2: Production -> Découpage (Multiple Products) -->
                                <div class="col-md-12 d-none" id="type2Section">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                ...
                                <!-- Type 3: Découpage -> Vente -->
                                <div class="col-md-12 d-none" id="type3Section">
                                ...
                                <div class="col-md-12 d-none" id="type4Section">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                ...
                                <!-- Type 5: Chutes -> Produits Finis -->
                                <div class="col-md-12 d-none" id="type5Section">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control" id="notes" name="notes" rows="3"
                                    placeholder="Instructions spéciales, notes de production...">{{ old('notes') }}</textarea>
                            </div>

                            <!-- Hidden fields for final form submission -->
                            <input type="hidden" id="actual_product_id" name="product_id" value="">
                            <input type="hidden" id="actual_source_product_id" name="source_product_id" value="">
                            <input type="hidden" id="actual_quantity_to_produce" name="quantity_to_produce"
                                value="">
                            <input type="hidden" id="actual_required_quantity" name="required_quantity" value="">
                            <input type="hidden" id="actual_decoupage_ratio" name="decoupage_ratio" value="">
                            <input type="hidden" id="actual_conversion_rate" name="conversion_rate" value="">
                            <input type="hidden" id="actual_waste_percentage" name="waste_percentage" value="0">
                            <input type="hidden" id="actual_material_source" name="material_source" value="bom_only">
                            <input type="hidden" id="actual_bom_percentage" name="bom_percentage" value="100">
                            <input type="hidden" id="actual_chutes_volume" name="chutes_volume" value="0">
                            <input type="hidden" id="actual_total_cost" name="total_cost" value="0">
                            ...
                            <div class="d-flex gap-2 mt-4">
                                <button type="submit" class="btn btn-primary" id="submitBtn">
                                    <i class="fas fa-save me-1"></i> Créer l'Ordre
                                </button>
    ...
    `;
        ...
        `);
            ...
            function submitProductionOrder($form, forceChutes) {
                ...
                $.ajax({
                    url: "{{ route('production-orders.store') }}",
                    type: "POST",
                    headers: {
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            submitBtn.prop('disabled', false).html(
                                '<i class="fas fa-save me-2"></i>Créer l\'Ordre');
                        }
                    },
                    error: function(xhr) {
                        const errors = xhr.responseJSON?.errors;
            ...
            const initialProductionType = $('input[name="production_type"]:checked').val();
            toggleProductionTypeSections(initialProductionType);
        });
    </script>
@endpush
