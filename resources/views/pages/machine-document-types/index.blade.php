...
@section('title', 'Types de Documents Machine')
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title">Types de Documents Machine</h4>
                ...
                <form id="createDocumentTypeForm">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Code unique (ex: maintenance_contract, inspection, etc.)</small>
                        </div>
                        <div class="mb-3">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#document-types-table').DataTable({ paging: false, lengthChange: false,
                processing: true,
                serverSide: true,
                ajax: "{{ route('machine-document-types.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $('#createDocumentTypeForm').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('machine-document-types.store') }}",
                    type: 'POST',
                    data: $(this).serialize(),
            ...
            $(document).on('click', '.edit-type', function() {
                ...
                $.ajax({
                    url: "{{ url('machine-document-types') }}/" + id + "/edit",
                    type: 'GET',
                    success: function(response) {
                        if (response.success) {
            ...
            $('#editDocumentTypeForm').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ url('machine-document-types') }}/" + id,
                    type: 'POST',
                    data: $(this).serialize(),
                    success: function(response) {
                        if (response.success) {
            ...
            $('#confirmDeleteBtn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('machine-document-types') }}/" + deleteId,
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
