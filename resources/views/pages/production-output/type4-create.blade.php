...
@section('title', 'Sortie de Production - Transformation Vente → Vente')
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title">Sortie de Production - Transformation Vente → Vente</h4>
            ...
            <div class="col-lg-6">
                <div class="card mb-4">
                    <div class="card-header bg-info text-white">
                        <h6 class="card-title mb-0">
                            <i class="fas fa-cogs me-2"></i>Résultats de Transformation
                        </h6>
                    </div>
                    <div class="card-body">
                        ...
                        <form id="productionOutputForm">
                            ...
                            <div class="d-grid gap-2 mt-4">
                                <button type="submit" class="btn btn-warning btn-lg text-white" id="submitBtn">
                                    <i class="fas fa-save me-2"></i> Enregistrer la Transformation
                                </button>
    ...
    <script>
        $(document).ready(function() {
            ...
            function displayOrderInfo(order) {
                const sourceProduct = order.sourceProduct || {};
                ...
                let html = `
                    <div class="order-info-card">
                        ...
                        <div class="order-info-row">
                            ...
                            <span class="order-info-value"><strong>${conversionDetails.source_product_name || sourceProduct.product_name || 'N/A'}</strong></span>
                        </div>
                        <div class="order-info-row">
                            <span class="order-info-label">Famille Source:</span>
                            <span class="order-info-value"><span class="badge bg-warning">${order.famille?.famille_name || 'Non spécifié'}</span></span>
                        </div>
                        <div class="mt-3">
                            <div class="progress">
            ...
            $('#productionOutputForm').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('production-output.store-type4') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
