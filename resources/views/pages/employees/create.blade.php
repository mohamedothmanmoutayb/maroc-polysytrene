            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title">Nouvel Employé</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-center mb-4">
                                    <div class="position-relative d-inline-block">
                                        <img src="{{ asset('assets/images/profile/user-1.jpg') }}" id="photoPreview"
                                    ...
                                    <p class="text-muted mt-3">Cliquez sur l'icône pour ajouter une photo</p>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="zk_uid"
                                                placeholder="ID utilisateur sur la pointeuse">
                                        </div>
