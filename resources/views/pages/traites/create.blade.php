            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title">Nouvelle Traite</h4>
                ...
                <div class="card">
                    <div class="card-header card-header-custom">
                        <h5 class="card-title mb-0" style="color:white">
                            <i class="fas fa-plus-circle me-2"></i>Enregistrer une Nouvelle Traite
                        </h5>
                    </div>
                    <div class="card-body">
                        <form id="traiteForm" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="traite_number" name="traite_number"
                                            value="{{ $nextTraiteNumber }}" required maxlength="50">
                                        <small class="form-text text-muted">Format: TR-YYYYMMDD-XXXX</small>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">Auto-rempli si vente sélectionnée. Si aucune
                                            vente, le montant sera ajouté au crédit client.</small>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="bank_name" name="bank_name"
                                            maxlength="100" placeholder="Ex: Attijariwafa Bank">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="drawee" name="drawee"
                                            maxlength="200" placeholder="Nom du tiré">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="drawee_address"
                                            name="drawee_address" placeholder="Adresse complète">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status" required>
                                            ...
                                            <option value="paid">Payé (créera un paiement immédiatement)</option>
                                            <option value="bounced">Rebondi</option>
                                        </select>
                                        <small class="form-text text-muted">Si "Payé" est sélectionné, un paiement sera
                                            automatiquement créé et le solde client sera mis à jour.</small>
                                    </div>
                                </div>
                            ...
                            <!-- Information Alerts -->
                            <div class="alert alert-info mb-4" id="orderInfoAlert" style="display: none;">
                                <i class="fas fa-shopping-cart me-2"></i>
                                <strong>Information Vente:</strong>
                                <ul class="mb-0 mt-2" id="orderInfoList">
                                    <li>Vente sélectionnée: <span id="selectedOrderNumber">-</span></li>
                                    <li>Montant total: <span id="selectedOrderTotal">-</span></li>
                                    <li>Reste à payer: <span id="selectedOrderRemaining">-</span></li>
                                    <li>Client: <span id="selectedOrderClient">-</span></li>
                                </ul>
                            </div>

                            <div class="alert alert-info mb-4" id="clientInfoAlert" style="display: none;">
                                <i class="fas fa-user me-2"></i>
                                <strong>Information Client:</strong>
                                <ul class="mb-0 mt-2" id="clientInfoList">
                                    <li>Client: <span id="selectedClientName">-</span></li>
                                    <li>Solde actuel: <span id="selectedClientBalance">-</span></li>
                                    <li>Situation: <span id="selectedClientStatus">-</span></li>
                                </ul>
                            </div>
