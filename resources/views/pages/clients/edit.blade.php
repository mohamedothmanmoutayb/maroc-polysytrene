            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title">Modifier Client</h4>
                ...
                <div class="card">
                    <div class="card-header card-header-custom">
                        <h5 class="card-title mb-0" style="color:white">
                            <i class="fas fa-edit me-2"></i>Modifier le Client: {{ $client->display_name }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <form id="clientForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="person_type" name="person_type" required>
                                            ...
                                            <option value="physique"
                                                {{ $client->person_type == 'physique' ? 'selected' : '' }}>Physique</option>
                                            <option value="morale" {{ $client->person_type == 'morale' ? 'selected' : '' }}>
                                                Morale</option>
                                            <option value="morale"
                                                {{ $client->person_type == 'special' ? 'selected' : '' }}>
                                                Spécial</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="client_type" name="client_type" required>
                                            ...
                                            <option value="client" {{ $client->client_type == 'client' ? 'selected' : '' }}>
                                                Client</option>
                                            <option value="commerciale"
                                                {{ $client->client_type == 'commerciale' ? 'selected' : '' }}>Commerciale
                                            </option>
                                            <option value="grossiste"
                                                {{ $client->client_type == 'grossiste' ? 'selected' : '' }}>Grossiste
                                            </option>
                                            <option value="special"
                                                {{ $client->client_type == 'special' ? 'selected' : '' }}>Spécial</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6" id="name-section">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                            value="{{ old('name', $client->name) }}" maxlength="100"
                                            placeholder="Ex: Ahmed Benali">
                                    </div>
                                </div>
                                <div class="col-md-6" id="entreprise-section">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="entreprise_name"
                                            ...
                                            value="{{ old('entreprise_name', $client->entreprise_name) }}" maxlength="100"
                                            placeholder="Ex: SARL MATELAS MAROC">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6" id="cin-section">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cin" name="cin"
                                            value="{{ old('cin', $client->cin) }}" maxlength="20"
                                            placeholder="Ex: AB123456">
                                    </div>
                                </div>
                                <div class="col-md-6" id="ice-section">
                                    <div class="form-group">
                                        <label for="ice" class="form-label">ICE</label>
                                        <input type="text" class="form-control" id="ice" name="ice"
                                            value="{{ old('ice', $client->ice) }}" maxlength="20"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="patente" name="patente"
                                            value="{{ old('patente', $client->patente) }}" maxlength="20"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="credit_limit" name="credit_limit"
                                            value="{{ old('credit_limit', $client->credit_limit) }}" min="0"
                                            step="0.01" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="is_active" name="is_active">
                                            <option value="1" {{ $client->is_active ? 'selected' : '' }}>Actif
                                            </option>
                                            <option value="0" {{ !$client->is_active ? 'selected' : '' }}>Inactif
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="alert alert-info">
                                ...
                                <strong>Gestion des documents:</strong> Vous pouvez gérer les documents du client
                                (CIN, ICE, RC, Patente, etc.) depuis
                                <a href="{{ route('clients.documents', $client->client_id) }}" class="alert-link">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            // Initialize based on current person type
            togglePersonTypeFields('{{ $client->person_type }}');
            ...
            $('#clientForm').submit(function(e) {
                ...
                if (!$('#credit_limit').val()) errors.push('Le plafond de crédit est requis');
                ...
                $.ajax({
                    url: "{{ route('clients.update', $client->client_id) }}",
                    type: "POST",
                    data: formData,
