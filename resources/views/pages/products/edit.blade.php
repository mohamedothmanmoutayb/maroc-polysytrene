            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title">Modifier Produit</h4>
                ...
                <div class="card">
                    <div class="card-header card-header-custom">
                        <h5 class="card-title mb-0" style="color:white">
                            <i class="fas fa-edit me-2"></i>Modifier : {{ $product->product_name }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <form id="productForm">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="product_code" name="product_code"
                                            value="{{ $product->product_code }}" required maxlength="50"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="product_name" name="product_name"
                                            value="{{ $product->product_name }}" required maxlength="255"
                                            placeholder="Ex: Matelas Épique 140x190">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="product_type" name="product_type" required>
                                            ...
                                            <option value="production"
                                                {{ $product->product_type == 'production' ? 'selected' : '' }}>Production
                                                (Bloc)</option>
                                            <option value="decoupage"
                                                {{ $product->product_type == 'decoupage' ? 'selected' : '' }}>Découpage
                                                (Sous Bloc)</option>
                                            <option value="finale"
                                                {{ $product->product_type == 'finale' ? 'selected' : '' }}>Produit Final
                                                (Volume)</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="unit_of_measure"
                                            name="unit_of_measure" maxlength="50"
                                            value="{{ $product->unit_of_measure ?? 'pièce' }}">
                                        <small class="form-text text-muted">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="height_m" name="height_m"
                                            min="0" step="0.001" value="{{ $product->height_m }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="width_m" name="width_m"
                                            min="0" step="0.001" value="{{ $product->width_m }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="depth_m" name="depth_m"
                                            min="0" step="0.001" value="{{ $product->depth_m }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="volume_m3" name="volume_m3"
                                            min="0" step="0.0001" value="{{ $product->volume_m3 }}"
                                            placeholder="Ex: 0.700" readonly>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="weight_kg" name="weight_kg"
                                            min="0" step="0.01" value="{{ $product->weight_kg }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="min_stock_level"
                                            ...
                                            value="{{ $product->min_stock_level }}" placeholder="Ex: 10.00">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="max_stock_level"
                                            ...
                                            value="{{ $product->max_stock_level }}" placeholder="Ex: 100.00">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="famillesContainer">
                                @foreach ($product->familles as $index => $famille)
                                    <div class="famille-row mb-3 border rounded p-3" data-index="{{ $index }}">
                                        <div class="row mb-2">
                                            <div class="col-md-12">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <h6 class="mb-0">Famille</h6>
                                                    <button type="button"
                                                        class="btn btn-sm btn-danger remove-famille-btn">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-control famille-select"
                                                    name="familles[{{ $index }}][famille_id]" required>
                                                    <option value="">Sélectionner une famille</option>
                                                    @foreach ($familles as $familleOption)
                                                        <option value="{{ $familleOption->famille_id }}"
                                                            data-prix-client="{{ $familleOption->prix_client }}"
                                                            data-prix-grossiste="{{ $familleOption->prix_grossiste }}"
                                                            data-prix-commercial="{{ $familleOption->prix_commercial }}"
                                                            data-prix-special="{{ $familleOption->prix_special }}"
                                                            {{ $famille->famille_id == $familleOption->famille_id ? 'selected' : '' }}>
                                                            {{ $familleOption->famille_name }}
                                                            ({{ $familleOption->famille_code }})
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <input type="number" class="form-control famille-prix-client"
                                                    name="familles[{{ $index }}][prix_client]" min="0"
                                                    step="0.01" value="{{ $famille->prix_client }}" required>
                                                <small
                                                    class="text-muted prix-client-standard">{{ number_format($famille->prix_client, 2, ',', '.') }}
                                                    DH (Std)</small>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">Prix Grossiste (DH) *</label>
                                                <input type="number" class="form-control famille-prix-grossiste"
                                                    name="familles[{{ $index }}][prix_grossiste]" min="0"
                                                    step="0.01" value="{{ $famille->prix_grossiste }}" required>
                                                <small
                                                    class="text-muted prix-grossiste-standard">{{ number_format($famille->prix_grossiste, 2, ',', '.') }}
                                                    DH (Std)</small>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">Prix Commercial (DH) *</label>
                                                <input type="number" class="form-control famille-prix-commercial"
                                                    name="familles[{{ $index }}][prix_commercial]" min="0"
                                                    step="0.01" value="{{ $famille->prix_commercial }}" required>
                                                <small
                                                    class="text-muted prix-commercial-standard">{{ number_format($famille->prix_commercial, 2, ',', '.') }}
                                                    DH (Std)</small>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">Prix Spécial *</label>
                                                <input type="number" class="form-control famille-prix-special"
                                                    name="familles[{{ $index }}][prix_special]" min="0"
                                                    step="0.01" value="{{ $famille->prix_special }}" required>
                                                <small
                                                    class="text-muted prix-special-standard">{{ number_format($famille->prix_special, 2, ',', '.') }}
                                                    DH (Std)</small>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                ...
                                <div class="famille-row mb-3 border rounded p-3">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12">
                                            <small class="text-muted">
                                                <i class="fas fa-info-circle"></i>
                                                Les prix standards de la famille sont affichés. Modifiez-les si ce produit a
                                                des prix différents.
                                            </small>
                                        </div>
                                    </div>
                            ...
                            <div class="section-header mb-4" id="bomSectionHeader"
                                style="{{ $product->product_type == 'production' ? '' : 'display: none;' }}">
                                <h6 class="section-title bg-primary text-white p-2 rounded">
                                    <i class="fas fa-list-alt me-2"></i>Nomenclature (BOM) *
                                </h6>
                            </div>

                            <div class="row mb-3" id="bomSection"
                                style="{{ $product->product_type == 'production' ? '' : 'display: none;' }}">
                                <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        ...
                                                        <select class="form-control select2-material"
                                                            name="bom_materials[]" required>
                                                            <option value="">Sélectionner une matière</option>
                                                            @foreach ($rawMaterials as $material)
                                                                <option value="{{ $material->material_id }}"
                                                                    data-unit="{{ $material->unit_of_measure }}"
                                                                    {{ $bom->material_id == $material->material_id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="number" class="form-control bom-quantity"
                                                            name="bom_quantities[]" min="0.001" step="0.001"
                                                            value="{{ $bom->quantity_required }}" required>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="form-label">Unité</label>
                                                        <div class="form-control-plaintext bom-unit">
                                                            {{ $bom->unit_of_measure ?? '-' }}</div>
                                                    </div>
                                                    <div class="col-md-1 d-flex align-items-end">
                                                        <button type="button"
                                                            class="btn btn-sm btn-danger remove-bom-btn">
                                                            <i class="fas fa-trash"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="is_active" name="is_active">
                                            <option value="1" {{ $product->is_active ? 'selected' : '' }}>Actif
                                            </option>
                                            <option value="0" {{ !$product->is_active ? 'selected' : '' }}>Inactif
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3"
                                    placeholder="Description du produit...">{{ $product->description }}</textarea>
                            </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            // Initialize Select2
            $('.famille-select, .select2-material').select2({
                language: "fr",
                placeholder: "Sélectionner...",
                allowClear: true
            });

            let familleRowIndex = {{ count($product->familles) }};
            ...
            function addFamilleRow(data = null) {
                ...
                $(row).find('.famille-select').on('change', function() {
                    const val = $(this).val();
                    const selectedOption = $(this).find('option[value="' + val + '"]');
                    const prixClient = parseFloat(selectedOption.attr('data-prix-client')) || 0;
                    const prixGrossiste = parseFloat(selectedOption.attr('data-prix-grossiste')) || 0;
                    const prixCommercial = parseFloat(selectedOption.attr('data-prix-commercial')) || 0;
                    const prixSpecial = parseFloat(selectedOption.attr('data-prix-special')) || 0;
                ...
                if (data) {
                    ...
                    setTimeout(() => {
                        $(row).find('.famille-prix-client').val(data.prix_client_m3 || data.prix_client);
                        $(row).find('.famille-prix-grossiste').val(data.prix_grossiste_m3 || data
                            .prix_grossiste);
                        $(row).find('.famille-prix-commercial').val(data.prix_commercial_m3 || data
                            .prix_commercial);
                        $(row).find('.famille-prix-special').val(data.prix_special_m3 || data.prix_special);
                    }, 100);
                }
            ...
            // Remove famille row
            $(document).on('click', '.remove-famille-btn', function() {
                const rowElement = $(this).closest('.famille-row');
                rowElement.addClass('removing');
                setTimeout(() => {
                    rowElement.remove();
                }, 300);
            ...
            $('#productForm').submit(function(e) {
                ...
                // Submit form
                $.ajax({
                    url: "{{ route('products.update', $product->product_id) }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
