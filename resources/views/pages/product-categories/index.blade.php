            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title">Gestion des Catégories de Produits</h4>
                ...
                <div class="card">
                    <div class="card-header card-header-custom d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0" style="color:white">
                            <i class="fas fa-tags me-2"></i>Liste des Catégories de Produits
                        </h5>
                        <div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.dropdown-item.edit', function() {
                ...
                $.ajax({
                    url: "{{ url('product-categories') }}/" + categoryId + "/edit",
                    type: "GET",
            ...
            $(document).on('click', '.dropdown-item.delete', function() {
                ...
                $('#deleteForm').attr('action', "{{ url('product-categories') }}/" + categoryId);
            ...
            $('#categoryForm').submit(function(e) {
                ...
                var url = categoryId ? "{{ url('product-categories') }}/" + categoryId :
